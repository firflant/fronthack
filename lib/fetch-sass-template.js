 ...
 */
module.exports = function (filepath, machinename, humanname, type, description, cb) {
  console.log('Creating new Sass file from template...')
  let templatePath = 'src/sass/components/!TEMPLATE.sass'
  if (type == 'layout') {
    const templatePath = 'src/sass/layout/!TEMPLATE.sass'
  }
