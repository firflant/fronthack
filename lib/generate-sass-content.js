...
module.exports = function (machinename, description, filename, cb) {
  ...
  githubGet('frontcraft/fronthack-repo', 'src/sass/components', function (err, data, content) {
    if (err) throw err
    if (content.includes(filename)) {
      ...
      githubGet('frontcraft/fronthack-repo', `src/sass/components/html/${machinename}.html`, function (err, data, content) {
        if (err) throw err
        ...
        console.log(consoleColors.fronthack, '--------------------------------------------------\n')
        githubGet('frontcraft/fronthack-repo', filepath, function (err, data, content) {
          if (err) throw err
