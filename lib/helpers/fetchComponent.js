...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(projectRoot, projectType, machinename) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            projectSrc = "".concat(projectRoot).concat(['react-next', 'jekyll'].includes(projectType) ? '' : '/src'); // Exceptional behavior when fetching global styles.
          ...
          case 5:
            ...
            baseStylesPath = "".concat(projectSrc, "/").concat(projectType.includes('react') ? 'style' : 'sass/base');
            _context4.next = 10;
          ...
          case 14:
            if (!(projectType.includes('react') && machinename === 'Form')) {
              _context4.next = 19;
              break;
            }
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 3:
                        ...
                        parsedContent = projectType === 'react-next' && file === "".concat(machinename, ".js") ? fileContent.replace("import React from 'react'\n", '') : fileContent;
                        _context3.next = 8;
          ...
          case 43:
            ...
            _context4.next = 47;
            return (0, _generateReactComponent["default"])(projectRoot, projectType, 'component', machinename, description);
