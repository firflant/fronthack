...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(projectRoot, config, machinename) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            projectSrc = "".concat(projectRoot).concat(config.src); // Exceptional behavior when fetching global styles.
          ...
          case 5:
            ...
            baseStylesPath = "".concat(projectSrc, "/").concat(config.type.includes('react') ? 'style' : 'sass/base');
            _context4.next = 10;
          ...
          case 14:
            if (!(config.type.includes('react') && machinename === 'Form')) {
              _context4.next = 19;
              break;
            }

            (0, _output["default"])('The advanced Fronthack Form component has been promoted to a standalone npm package. To use it on a project, do following:');
            (0, _output["default"])('yarn add react-standalone-form'); // Behavior when fetching everything else.

            _context4.next = 79;
            break;

          case 19:
            (0, _output["default"])('Fetching data from a Fronthack components repository...');
            _context4.next = 22;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 3:
                        ...
                        parsedContent = config.type === 'react-next' && file === "".concat(machinename, ".js") ? fileContent.replace("import React from 'react'\n", '') : fileContent;
                        _context3.next = 8;
          ...
          case 36:
            (0, _output["default"])('Found Fronthack component of given name and imported its code.');
            _context4.next = 47;
            break;

          case 39:
            (0, _output["default"])("There is no ready Fronthack component of name ".concat(machinename, "."));
            (0, _output["default"])('Generating a new blank one...');
            _context4.next = 43;
          ...
          case 43:
            ...
            _context4.next = 47;
            return (0, _generateReactComponent["default"])(projectRoot, config, 'component', machinename, description);
