...
module.exports = (projectRoot, type, machinename, description, cb = () => null) => {
  getInstalledPath('fronthack').then((path) => {
    fs.mkdir(`${projectRoot}/src/${type}/${machinename}`, (err) => {
      if (err) throw err
      ...
      fs.readFile(`${path}/lib/templates/react-component.js`, 'utf8', (err, reactComponent) => {
        ...
        fs.writeFile(`${projectRoot}/src/${type}/${machinename}/${machinename}.js`, parsedReactComponent, (err) => {
          if (err) throw err
          // Fetch sass template
          fs.readFile(`${path}/lib/templates/sass-component.sass`, 'utf8', (err, sassContent) => {
            ...
            fs.writeFile(`${projectRoot}/src/${type}/${machinename}/style.sass`, parsedSassContent, (err) => {
              if (err) throw err
              ...
              fs.readFile(`${path}/lib/templates/react-component-index.js`, 'utf8', (err, indexFile) => {
                ...
                fs.writeFile(`${projectRoot}/src/${type}/${machinename}/index.js`, parsedIndexFile, (err) => {
                  if (err) throw err
