      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            filledConfig = config.replace('TYPE_UNDEFINED', type).replace('SRC_UNDEFINED', ['react', 'static'].includes(type) ? '/src' : '').replace('VERSION_UNDEFINED', JSON.parse(fronthackJson).version);
            _context.next = 10;
