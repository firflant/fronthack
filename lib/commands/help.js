...
var _default = function _default() {
  var sections = [{
    ...
    content: ['A commandline generator tool for the projects based on Fronthack ', '{underline http://fronthack.com}']
  }, {
    ...
    content: ['Looking for more help? Check out the official Fronthack docs: {underline https://docs.fronthack.com}']
  }];
