...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(projectRoot, config) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            html = {
              files: pageFiles.filter(function (n) {
                return n.includes('.html') || n.includes('.md') || n.includes('.markdown');
              }),
          ...
          case 36:
            // Display output.
            (0, _output["default"])("Done! ".concat(selectedDesign, " attached to ").concat(selectedHtml, " page."));
            _context.next = 42;
            break;
