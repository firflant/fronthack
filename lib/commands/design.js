...
function () {
  ...
  regeneratorRuntime.mark(function _callee(projectRoot) {
    var pageFiles, html, designFiles, design, _ref2, htmlIndex, designIndex, selectedHtml, selectedHtmlName, selectedDesign, path, data, dimensions;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 27:
            _context.next = 29;
            return _fsExtra.default.readFile(path, 'utf8');

          case 29:
            data = _context.sent;
            dimensions = (0, _imageSize.default)("".concat(projectRoot, "/src/designs/").concat(selectedDesign)); // If width is bigger than 2000px, it means that it is doublesized.
            ...
            data = "".concat(data, ".show-designs .designs--").concat(selectedHtmlName, ", .show-code-designs .designs--").concat(selectedHtmlName, " { background-image: url('../designs/").concat(selectedDesign, "'); width: ").concat(dimensions.width, "px; margin: 0 ").concat(dimensions.width / -2, "px; }\n");
            _context.next = 36;
            return afs.writeFile(path, data);
