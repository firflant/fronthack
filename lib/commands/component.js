    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            parsedName = config.type.includes('react') ? _case["default"].pascal(name) : _case["default"].kebab(name);
            _context.next = 11;
            return (0, _fetchComponent["default"])(projectRoot, config, parsedName);
