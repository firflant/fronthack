 ...
 */
module.exports = (projectSrc, type, machinename, description = null, cb = () => null) => {
  getFronthackPath(fronthackPath => {
    ...
    fs.readFile(`${fronthackPath}/templates/sass-component.sass`, 'utf8', (err, sassContent) => {
      ...
      fs.writeFile(`${projectSrc}/sass/${type}s/_${checkedMachinename}.sass`, parsedSassContent, (err) => {
        if (err) throw err
        addImportToApp(projectSrc, type, checkedMachinename, () => {
